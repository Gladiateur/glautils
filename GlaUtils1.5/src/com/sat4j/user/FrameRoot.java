...
//	}
	 ...
	 * @throws ClassNotFoundException 
	 * */
	public final String[] getTablesName(String dbName) throws ClassNotFoundException {
	 ...
	 * 该方法已过时。
	 * <p>
	 * 现由meta-sql-1.0.jar的EntityWriter.autobeans()方法来生成实体类。
	 * </p>
	 * @throws ClassNotFoundException 
	 * */
	@Deprecated
	private final void autoBeans0() throws ClassNotFoundException {
		try {
			this.getConnection(); 
